...
def open_loop():
    ...
    if open_loop_window is False:
        ...
        control_window_1.geometry("400x400")
        ...
        Lazo_abierto_imag.place(x=0, y=300)
        ...
        Lazo_abierto_SC_imag.place(x=0, y=150)
        ...
        label_text_3 = tk.Label(control_window_1, text="tomar en cuenta lo que ocurrirá en la señal de salida. Es-", font=font_bold_2, fg="black")
        label_text_4 = tk.Label(control_window_1, text="tos sistemas, en pocas palabras, no requieren una retro-", font=font_bold_2, fg="black")
        label_text_5 = tk.Label(control_window_1, text="alimentación porque la señal de salida no actúa sobre los", font=font_bold_2, fg="black")
        label_text_6 = tk.Label(control_window_1, text="parámetros de la señal de entrada.", font=font_bold_2, fg="black")
        label_text_7 = tk.Label(control_window_1, text="Estos sistemas de control se pueden dividir en dos ti-", font=font_bold_2, fg="black")
        label_text_8 = tk.Label(control_window_1, text="pos: Sistemas Sin control y Con control.", font=font_bold_2, fg="black")
        label_text_1.place(x=4,y=1)
        label_text_2.place(x=4,y=15)
        label_text_3.place(x=2,y=30)
        label_text_4.place(x=2,y=45)
        label_text_5.place(x=0,y=60)
        label_text_6.place(x=0,y=75)
        label_text_7.place(x=20,y=100)
        label_text_8.place(x=0,y=115)
        no_controlB = tk.Button(control_window_1, text="Sin control",font=font_bold_1,command=no_control, width=41)
        no_controlB.place(x=2,y=135)
        yes_controlB = tk.Button(control_window_1, text="Con control",font=font_bold_1,command=yes_control, width=41)
        yes_controlB.place(x=2,y=260)
        ...
        left_window(control_window_1, 400, 400)
...
def close_loop():
    ...
    if close_loop_window is False:
        ...
        control_window_2.geometry("400x550")
        ...
        Lazo_cerrado_imag.place(x=0, y=390)
        ...
        Lazo_cerrado_SC_imag.place(x=0, y=180)
        font_bold_1 = ("Arial", 12, "bold")
        font_bold_2 = ("Arial", 10, "bold")
        ...
        label_text_4 = tk.Label(control_window_2, text="ón se presenta de la salida frente a la referencia. En esen-", font=font_bold_2, fg="black")
        label_text_5 = tk.Label(control_window_2, text="cia, el sistema aprende de su propio rendimiento anterior", font=font_bold_2, fg="black")
        label_text_6 = tk.Label(control_window_2, text="y realiza ajustes para mantenerse en sintonía con el obje-", font=font_bold_2, fg="black")
        label_text_7 = tk.Label(control_window_2, text="tivo.", font=font_bold_2, fg="black")
        label_text_8 = tk.Label(control_window_2, text="Estos sistemas de control se pueden dividir en dos ti- ", font=font_bold_2, fg="black")
        label_text_9 = tk.Label(control_window_2, text="pos: Sistemas Sin Control y Con Control. ", font=font_bold_2, fg="black")
        ...
        right_window(control_window_2, 400, 550)
    pass